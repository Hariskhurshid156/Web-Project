...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.php" class="logo">
      ...
      <span class="logo-lg"><b>ACCS</b>Dashboard</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">ACCS</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  ACCS- Advisor and Career Counselor
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            ...
            <span class="pull-right-container">s
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg">
                      <div class="direct-chat-info clearfix">
                        <span class="direct-chat-name pull-left">ACCS</span>
                      ...
                      <li>
                        <a href="#">
                          ...
                          <div class="contacts-list-info">
                                <span class="contacts-list-name">
                                  Kenneth M.
                                  <small class="contacts-list-date pull-right">1/12/2018</small>
                                </span>
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    <li>
                      ...
                      <a class="users-list-name" href="#">ACCS</a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018-2020 <a href="https://adminlte.io">ACCS</a>.</strong> All rights
    reserved.
  </footer>
