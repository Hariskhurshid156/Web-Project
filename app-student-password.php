...
<?php  
  ...
  $accountpass = 'active';
  $accdrop ='in'; 
  $accountprofile = $dashboard = $courses = $messages = $mycourse = $takecourse = $courselist = $crsdrop=$counselor ='';
  ...
  if (isset($_POST['resetpassword'])) {
    ...
    if (!empty($old)) {
      $old = md5($old);
      $sql = "SELECT password from students where id = '$id' && password = '$old'";
              ...
              <div class="tabbable paper-shadow relative" data-z="0.5">
                ...
                <div class="tab-content">
                  ...
                  <div id="account" class="tab-pane active">
                    <form class="form-horizontal" method="post" action="app-student-password.php">
