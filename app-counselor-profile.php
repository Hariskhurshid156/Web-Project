...
$id = $_SESSION['tid'];
  ...
  if (isset($_POST['editprofile'])) {
    ...
    if (empty($emailErr) && empty($nameErr)) {
      $query = "UPDATE counselor 
                SET 
                name='$name' , email='$email' , skype_id='$skype' , phone_number='$phone' , qualification='$qualification' , picture='$filename'
                WHERE id='$id'";
              ...
              <div class="tabbable paper-shadow relative" data-z="0.5">
                ...
                <div class="tab-content">
                  ...
                  <div id="account" class="tab-pane active">
                    <form class="form-horizontal" method="post" action="app-counselor-profile.php" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                          <div class="form-control-material">
                            <div class="input-group">
                              ...
                              <label for="inputEmail3">Email qualification</label>
                            </div>
                      ...
                      <div class="form-group">
                        <label for="qualification" class="col-md-2 control-label">Qualification</label>
                        <div class="col-md-6">
                          <div class="form-control-material">
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
                              <input type="text" class="form-control used" id="qualification" name="qualification" placeholder="Your qualification" value="<?php echo $row['qualification']; ?>">
